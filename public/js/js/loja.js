...
function filtrarProdutos(marca) {
    ...
    produtos.forEach(produto => {
        if (produto.getAttribute('data-marca') === marca) {
            produto.style.display = 'flex'; // Mostra o produto se a marca corresponder
        } else {
            produto.style.display = 'none'; // Esconde o produto se a marca não corresponder
        }
    });
}
